...
public class DepartmentListController implements Initializable, DataChangeListener {
	...
	private void removeEntity(Department obj) {
		...
		// result.get porque o Optional é um objeto que
		// carrega outro objeto dentro dele. 
		// Podendo esse objto estar presente ou não.
		// Para a gente acessar esse objeto que está
		// dentro do Optional a gente precisa chamar o ".get".
