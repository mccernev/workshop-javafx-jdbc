...
public class MainViewController implements Initializable {
	...
	// porque as aplicações gráficas são multitrading, você pode acrescentar, antes do void, 
	// o termo "synchronized"
	// Assim você garante que esse processamento todo não vai ser interrompido durante o 
	// multitrading.
		...
		try {
			...
			// Para ter condição de trabalhar com a janela principal vou ter que pegar uma referência da cena.
			// Essa cena em que a janela principal está, foi declarada na classe principal (Main.java).
						
			// Aqui no controlador vou pegar aquela referẽncia 
			// da cena que está na classe Main.java:
			Scene mainScene = Main.getMainScene();
			// Precisamos da referência da cena porque vou ter que pegar uma referẽncia do VBox da janela principal,
			// lá no meu MainView.fxml e eu vou precisar acrescentar nos children desse VBox,
			// os children do VBox da janela About.
			// Ou seja, eu vou precisar acrescentar os filhos da janela About na janela principal 
			// Fazer uma espécie de "substituição" dos elementos presentes numa janela pelos elementos
			...
			// que é o ScrollPane. Então vou precisar fazer o casting desse getRoot para ScrollPane.
			// Dentro do ScrollPane eu tenho o elemento "content", para acessa-lo tenho que acrescentar .getContent();
			...
			// Tenho que preservar o menuBar, ele sempre estará presente na minnha aplicação.
			// Vou ter que excluir tudo o que estiver nos filhos da página prncipal;
			// Vou ter que incluir esse menuBar, e em seguida, os filhos do VBox da tela About.
			// Para fazer isto:
